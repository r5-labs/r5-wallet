...
export const AppVersion = "1.0.1 Beta" // Don't change this!
export const HelpUrl = "https://docs.r5.network/tutorials-and-guides/r5-desktop-wallet" // Don't change this!
export const RpcUrl = "https://rpc-testnet.r5.network" // Use your own RPC server or a public one
export const ExplorerUrl = "https://explorer-testnet.r5.network" // You can change the preferred explorer URL
